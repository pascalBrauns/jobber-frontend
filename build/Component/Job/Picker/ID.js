...
var ID = function (props) {
    ...
    return (react_1.default.createElement(TextField_1.default, { placeholder: 'Search ID', variant: 'outlined', value: id, style: {
            width: '80%'
        }, onChange: function (event) { return setID({
            id: event.target.value
        }); } }));
};
var enhance = react_redux_1.connect(function (state) { return ({
    id: state.Picker.Filter.id
}); }, Action);
